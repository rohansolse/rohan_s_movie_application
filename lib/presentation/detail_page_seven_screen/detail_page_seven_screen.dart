...
class DetailPageSevenScreen extends StatelessWidget {
  ...
  /// Section Widget
  Widget _buildMovieCardRow(BuildContext context) {
    return Align(
        alignment: Alignment.centerLeft,
        child: Padding(
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 243.v,
        child: BlocSelector<DetailPageSevenBloc, DetailPageSevenState,
                DetailPageSevenModel?>(
            selector: (state) => state.detailPageSevenModelObj,
            builder: (context, detailPageSevenModelObj) {
              return ListView.separated(
                  ...
                  itemCount:
                      detailPageSevenModelObj?.moviesItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    MoviesItemModel model =
                        detailPageSevenModelObj?.moviesItemList[index] ??
                            MoviesItemModel();

import '../detail_page_eight_screen/widgets/movies4_item_widget.dart';
...
class DetailPageEightScreen extends StatelessWidget {
  ...
  /// Section Widget
  Widget _buildBackgroundBlur(BuildContext context) {
    return SizedBox(
        height: 188.v,
        width: double.maxFinite,
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 243.v,
        child: BlocSelector<DetailPageEightBloc, DetailPageEightState,
                DetailPageEightModel?>(
            selector: (state) => state.detailPageEightModelObj,
            builder: (context, detailPageEightModelObj) {
              return ListView.separated(
                  ...
                  itemCount:
                      detailPageEightModelObj?.movies4ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Movies4ItemModel model =
                        detailPageEightModelObj?.movies4ItemList[index] ??
                            Movies4ItemModel();

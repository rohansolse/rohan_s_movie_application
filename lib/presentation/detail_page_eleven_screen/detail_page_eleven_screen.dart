...
class DetailPageElevenScreen extends StatelessWidget {
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 243.v,
        child: BlocSelector<DetailPageElevenBloc, DetailPageElevenState,
                DetailPageElevenModel?>(
            selector: (state) => state.detailPageElevenModelObj,
            builder: (context, detailPageElevenModelObj) {
              return ListView.separated(
                  ...
                  itemCount:
                      detailPageElevenModelObj?.movies3ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Movies3ItemModel model =
                        detailPageElevenModelObj?.movies3ItemList[index] ??
                            Movies3ItemModel();
